...
// isReachableFuncFromFunc determines if the target function is reachable from the start function
...
func (self *staticData) TestReachable() {
	...
	res, path, err := self.isReachableFuncFromFunc(mainFunc, fFunc, true)
	if err != nil {
