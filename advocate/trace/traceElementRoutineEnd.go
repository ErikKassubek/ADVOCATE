...
func (re *TraceElementRoutineEnd) AddChild(elem TraceElement) {
}
...
func (re *TraceElementRoutineEnd) GetChildren() []TraceElement {
...
func (re *TraceElementRoutineEnd) GetParents() []TraceElement {
	return make([]TraceElement, 0)
}
