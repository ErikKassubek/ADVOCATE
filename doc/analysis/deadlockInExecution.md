...
```go
gocctgo.DetectPartialDeadlock(1000)
```
...
When using gocct in the fuzzing mode, the partial deadlock detection
...
- routID: the id of the blocked routine. If run while gocct recording is run
