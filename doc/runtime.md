...
- [src/gocct/gocct_fuzzing.go](../goPatch/src/gocct/gocct_fuzzing.go)
- [src/gocct/gocct_replay.go](../goPatch/src/gocct/gocct_replay.go)
- [src/gocct/gocct_tracing.go](../goPatch/src/gocct/gocct_tracing.go)
- [src/runtime/gocct_exit.go](../goPatch/src/runtime/gocct_exit.go)
- [src/runtime/gocct_fuzzing.go](../goPatch/src/runtime/gocct_fuzzing.go)
- [src/runtime/gocct_ids.go](../goPatch/src/runtime/gocct_ids.go)
- [src/runtime/gocct_replay.go](../goPatch/src/runtime/gocct_replay.go)
- [src/runtime/gocct_routine.go](../goPatch/src/runtime/gocct_routine.go)
- [src/runtime/gocct_time.go](../goPatch/src/runtime/gocct_time.go)
- [src/runtime/gocct_trace.go](../goPatch/src/runtime/gocct_trace.go)
- [src/runtime/gocct_trace_atomic.go](../goPatch/src/runtime/gocct_trace_atomic.go)
- [src/runtime/gocct_trace_channel.go](../goPatch/src/runtime/gocct_trace_channel.go)
- [src/runtime/gocct_trace_cond.go](../goPatch/src/runtime/gocct_trace_cond.go)
- [src/runtime/gocct_trace_mutex.go](../goPatch/src/runtime/gocct_trace_mutex.go)
- [src/runtime/gocct_new_elem.go](../goPatch/src/runtime/gocct_trace_new_elem.go)
- [src/runtime/gocct_trace_once.go](../goPatch/src/runtime/gocct_trace_once.go)
- [src/runtime/gocct_trace_routine.go](../goPatch/src/runtime/gocct_trace_routine.go)
- [src/runtime/gocct_trace_select.go](../goPatch/src/runtime/gocct_trace_select.go)
- [src/runtime/gocct_trace_waitgroup.go](../goPatch/src/runtime/gocct_trace_waitgroup.go)
- [src/runtime/gocct_tracing.go](../goPatch/src/runtime/gocct_tracing.go)
- [src/runtime/gocct_util.go](../goPatch/src/runtime/gocct_util.go)
- [src/runtime/gocct_wait.go](../goPatch/src/runtime/gocct_wait.go)
- [src/cmd/compile/internal/walk/gocct.go](../goPatch/src/cmd/compile/internal/ssawalken/gocct.go)
