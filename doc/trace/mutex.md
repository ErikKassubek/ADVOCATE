...
`goPatch/src/runtime/gocct_trace.go` in the functions [AdvocateMutexPre](../../goPatch/src/runtime/gocct_trace_mutex.go#L46) and [AdvocateMutexPost](../../goPatch/src/runtime/gocct_trace_mutex.go#L77)
