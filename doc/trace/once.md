...
The recording of the operations is done in the `goPatch/src/sync/once.go` file in the [Do](../../goPatch/src/sync/once.go#L60) function. The recording is done with the [GocdrOncePre](../../goPatch/src/runtime/gocdr_trace_once.go#40) and [GocdrOncePost](../../goPatch/src/runtime/gocdr_trace_once.go#68) functions.
