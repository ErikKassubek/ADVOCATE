...
The call to record the routine is set in runtime/proc.go in the [goexit1](../../goPatch/src/runtime/proc.go#L4327) function using the [AdvocateRoutineExit](../../goPatch/src/runtime/gocct_trace_routine.go#L67) function.
