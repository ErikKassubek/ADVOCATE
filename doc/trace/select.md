...
We implement a [Pre](../../goPatch/src/runtime/gocct_trace_select.go#L189) and a [Post](../../goPatch/src/runtime/gocct_trace_select.go#L249) function for the select case with exactly one non default case and separate [Pre](../../goPatch/src/runtime/gocct_trace_select.go#L51) and [Post](../../goPatch/src/runtime/gocct_trace_select.go#L141) functions for all other selects.
...
To now record the involved channels in the [Pre](../../goPatch/src/runtime/gocct_trace_select.go#L51)
...
For the [Post](../../goPatch/src/runtime/gocct_trace_select.go#L141)
