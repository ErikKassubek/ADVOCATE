...
func NewPoGraph() PoGraph {
	po.chanBuffer = make(map[int]([]a_base.BufferedVC))
	...
	return PoGraph{
		...
		relR:           make(map[int]*a_base.ElemWithVc),
		relW:           make(map[int]*a_base.ElemWithVc),
