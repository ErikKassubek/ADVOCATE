...
// This is a bootstrap copy of /home/erik/Arbeit/Advocate/goPatch/src/cmd/compile/internal/ssagen/ssa.go

//line /home/erik/Arbeit/Advocate/goPatch/src/cmd/compile/internal/ssagen/ssa.go:1
...
func (s *state) advocateExitCall(fn *ir.Func) {
	...
	// println(fn.Sym().Name, fn.Sym().Pkg.Path)
