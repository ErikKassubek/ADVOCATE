...
var tracePathRecorded = "gocctTrace"
...
//
//go:linkname InitTracing runtime.GoCCTInitTracing
...
// The trace is written in the format of gocct.
//
//go:linkname FinishTracing runtime.GoCCTFinishTracing
func FinishTracing() {
	if hasFinished {
