...
var (
	gocctFuzzingEnabled       = false
	gocctFuzzingDelayEnabled  = false
	gocctFuzzingReplayEnabled = false
...
func InitFuzzingDelay(selectData map[string][]int, fuzzingFlow map[string][]int, finishFuzzing func()) {
	...
	gocctFuzzingEnabled = true
	gocctFuzzingDelayEnabled = true
...
//
// Parameter:
//   - finishFuzzing func(): gocct.FinishFuzzing function
func InitFuzzingReplay(finishFuzzing func()) {
	finishFuzzingFunc = finishFuzzing
	gocctFuzzingEnabled = true
	gocctFuzzingReplayEnabled = true
}
...
func IsGoCCTFuzzingEnabled() bool {
	return gocctFuzzingEnabled
}
...
func GoCCTFuzzingGetPreferredCase(skip int) (bool, int) {
	if !gocctFuzzingEnabled {
		return false, 0
	}
