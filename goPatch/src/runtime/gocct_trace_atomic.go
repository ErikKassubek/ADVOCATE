...
func GoCCTAtomic[T int32 | int64 | uint32 | uint64 | uintptr | unsafe.Pointer](addr *T, op Operation, skip int) {
	...
	res := GoCCTTraceResource{id: id, addr: unsafeAddr}

	elem := GoCCTTraceAtomic{
		t:    timer,
		res:  res,
		op:   op,
		file: file,
...
func (self GoCCTTraceAtomic) toString() string {
	opStr := "U"
	switch self.op {
...
func (self GoCCTTraceAtomic) getOperation() Operation {
	return self.op
}
...
func (self GoCCTTraceAtomic) hasCommit() bool {
	return true
}
...
func (self GoCCTTraceAtomic) resource() []GoCCTTraceResource {
