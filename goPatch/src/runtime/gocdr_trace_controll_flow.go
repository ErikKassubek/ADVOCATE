...
//   - file string: file
//   - line int: first line
type GoCDRTraceControllFlow struct {
	t          int64
	numCases   int
	chosenCase int
	ct         Operation
...
// TODO: fix line
// GoCDRControllFlow inserts a conditional into the trace
//
// Parameter:
//   - ct string: "I" for if, "S" for switch
//   - numCases int: number of cases
//   - chosenCase int: number of chosen case
func gocdrControllFlow(ct string, numCases, chosenCase int) {
...
func (self GoCDRTraceControllFlow) toString() string {
	ctString := ""
	switch self.ct {
...
func (self GoCDRTraceControllFlow) getOperation() Operation {
	return self.ct
}
...
func (self GoCDRTraceControllFlow) hasCommit() bool {
	return true
}
...
func (self GoCDRTraceControllFlow) resource() []GoCDRTraceResource {
