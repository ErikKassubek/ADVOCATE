...
/*
 * GocdrChanMake adds a channel make to the trace.
 * Args:
 ...
 */
func GocdrChanMake(qSize int) uint64 {
...
func (elem GocdrTraceNewElem) toString() string {
	operationType := "NC"
...
func (elem GocdrTraceNewElem) getOpStr() string {
	return "NC"
}
...
func (elem GocdrTraceNewElem) getOperation() Operation {
	return elem.op
}
