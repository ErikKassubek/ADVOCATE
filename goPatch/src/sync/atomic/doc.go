...
//
//go:noescape
func SwapInt32Oosc(addr *int32, new int32) (old int32)

// SwapUint32 atomically stores new into *addr and returns the previous *addr value.
// Consider using the more ergonomic and less error-prone [Uint32.Swap] instead.
//
//go:noescape
func SwapUint32Oosc(addr *uint32, new uint32) (old uint32)

// SwapUintptr atomically stores new into *addr and returns the previous *addr value.
// Consider using the more ergonomic and less error-prone [Uintptr.Swap] instead.
//
//go:noescape
func SwapUintptrOosc(addr *uintptr, new uintptr) (old uintptr)
...
//
//go:noescape
func CompareAndSwapInt32Oosc(addr *int32, old, new int32) (swapped bool)

// CompareAndSwapUint32 executes the compare-and-swap operation for a uint32 value.
// Consider using the more ergonomic and less error-prone [Uint32.CompareAndSwap] instead.
//
//go:noescape
func CompareAndSwapUint32Oosc(addr *uint32, old, new uint32) (swapped bool)

// CompareAndSwapUintptr executes the compare-and-swap operation for a uintptr value.
// Consider using the more ergonomic and less error-prone [Uintptr.CompareAndSwap] instead.
//
//go:noescape
func CompareAndSwapUintptrOosc(addr *uintptr, old, new uintptr) (swapped bool)
...
//
//go:noescape
func AddInt32Oosc(addr *int32, delta int32) (new int32)
...
//
//go:noescape
func AddUint32Oosc(addr *uint32, delta uint32) (new uint32)

// AddUintptr atomically adds delta to *addr and returns the new value.
// Consider using the more ergonomic and less error-prone [Uintptr.Add] instead.
//
//go:noescape
func AddUintptrOosc(addr *uintptr, delta uintptr) (new uintptr)
...
//
//go:noescape
func AndInt32Oosc(addr *int32, mask int32) (old int32)
...
//
//go:noescape
func AndUint32Oosc(addr *uint32, mask uint32) (old uint32)
...
//
//go:noescape
func AndUintptrOosc(addr *uintptr, mask uintptr) (old uintptr)
...
//
//go:noescape
func OrInt32Oosc(addr *int32, mask int32) (old int32)
...
//
//go:noescape
func OrUint32Oosc(addr *uint32, mask uint32) (old uint32)
...
//
//go:noescape
func OrUintptrOosc(addr *uintptr, mask uintptr) (old uintptr)

// LoadInt32 atomically loads *addr.
// Consider using the more ergonomic and less error-prone [Int32.Load] instead.
//
//go:noescape
func LoadInt32Oosc(addr *int32) (val int32)

// LoadUint32 atomically loads *addr.
// Consider using the more ergonomic and less error-prone [Uint32.Load] instead.
//
//go:noescape
func LoadUint32Oosc(addr *uint32) (val uint32)

// LoadUintptr atomically loads *addr.
// Consider using the more ergonomic and less error-prone [Uintptr.Load] instead.
//
//go:noescape
func LoadUintptrOosc(addr *uintptr) (val uintptr)

// LoadPointer atomically loads *addr.
// Consider using the more ergonomic and less error-prone [Pointer.Load] instead.
func LoadPointerOosc(addr *unsafe.Pointer) (val unsafe.Pointer)

// StoreInt32 atomically stores val into *addr.
// Consider using the more ergonomic and less error-prone [Int32.Store] instead.
//
//go:noescape
func StoreInt32Oosc(addr *int32, val int32)

// StoreUint32 atomically stores val into *addr.
// Consider using the more ergonomic and less error-prone [Uint32.Store] instead.
//
//go:noescape
func StoreUint32Oosc(addr *uint32, val uint32)

// StoreUintptr atomically stores val into *addr.
// Consider using the more ergonomic and less error-prone [Uintptr.Store] instead.
//
//go:noescape
func StoreUintptrOosc(addr *uintptr, val uintptr)
