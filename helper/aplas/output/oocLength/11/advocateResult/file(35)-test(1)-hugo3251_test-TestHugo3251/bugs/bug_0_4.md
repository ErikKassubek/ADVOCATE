...
- File: /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/11/blocking/hugo/3251/hugo3251_test.go
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/11/blocking/hugo/3251/hugo3251_test.go#60
```go
49 ...
50 
51 				for j := 0; j < 10; j++ {
52 					err := resGetRemote(url)
53 					if err != nil {
54 						fmt.Errorf("Error getting resource content: %s", err)
55 					}
56 					time.Sleep(300 * time.Nanosecond)
57 				}
58 			}(i)
59 		}
60 		wg.Wait()           // <-------
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/11/blocking/hugo/3251/hugo3251_test.go#24
```go
13 ...
14 
15 	sync.RWMutex
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/11/blocking/hugo/3251/hugo3251_test.go#29
```go
18 ...
19 
20 	l.Lock()
