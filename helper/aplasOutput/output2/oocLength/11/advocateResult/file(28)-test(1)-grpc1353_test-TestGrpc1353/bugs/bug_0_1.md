...
- File: /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/11/blocking/grpc/1353/grpc1353_test.go
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/11/blocking/grpc/1353/grpc1353_test.go#162
```go
151 ...
152 
153 /// 					rr.addrCh <- true
154 /// ----------------------G2, G3 deadlock-----------------------
155 ///
156 func TestGrpc1353(t *testing.T) {
157 	HelpCh = make(chan struct{})
158 	cc := NewClientConn()
159 	cc.dopts.balancer.Start() // G1
160 	go cc.lbWatcher()         // G3
161 	go func() {
162 		<-HelpCh           // <-------
163 		cc.dopts.balancer.Close()
164 	}()
165 }
166 
```
