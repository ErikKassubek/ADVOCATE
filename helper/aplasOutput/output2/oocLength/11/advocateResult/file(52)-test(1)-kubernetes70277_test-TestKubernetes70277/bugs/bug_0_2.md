...
- Test/Prog: TestKubernetes70277
- File: /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/11/blocking/kubernetes/70277/kubernetes70277_test.go
- Trace: advocateTrace_53
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/11/blocking/kubernetes/70277/kubernetes70277_test.go#79
```go
68 ...
69 
70 	var doneCh <-chan struct{}
71 
72 	WaitFor(func(done <-chan struct{}) <-chan struct{} {
73 		doneCh = done
74 		return waitFunc(done)
75 	}, func() (bool, error) {
76 		return true, nil
77 	}, stopCh)
78 
79 	<-doneCh // block here           // <-------
80 }
81 
```
