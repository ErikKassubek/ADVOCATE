...
###  Channel: Receive
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/cockroach/10790/cockroach10790_test.go#63
```go
52 ...
53 
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/cockroach/2448/cockroach2448_test.go#59
```go
48 ...
49 
50 }
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/cockroach/2448/cockroach2448_test.go#30
```go
19 ...
20 
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/cockroach/35073/cockroach35073_test.go#49
```go
38 ...
39 
40 	}
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/cockroach/6181/cockroach6181_test.go#30
```go
19 ...
20 
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/etcd/6873/etcd6873_test.go#39
```go
28 ...
29 
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/etcd/6873/etcd6873_test.go#47
```go
36 ...
37 
38 	wbs.mu.Lock()
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/grpc/1353/grpc1353_test.go#79
```go
68 ...
69 
70 	if rr.addrCh != nil {
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/grpc/1353/grpc1353_test.go#83
```go
72 ...
73 
74 
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/grpc/3017/grpc3017_test.go#31
```go
20 ...
21 
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/grpc/3017/grpc3017_test.go#64
```go
53 ...
54 
55 	}
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/grpc/795/grpc795_test.go#15
```go
4 ...
5 
6 )
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/grpc/795/grpc795_test.go#24
```go
13 ...
14 
15 	if s.drain == true {
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/istio/16224/istio16224_test.go#106
```go
95 ...
96 
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/istio/16224/istio16224_test.go#98
```go
87 ...
88 
89 	lock := sync.Mutex{}
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/istio/17860/istio17860_test.go#71
```go
60 ...
61 
62 	a.waitUntilLive()
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/hugo/3251/hugo3251_test.go#21
```go
10 ...
11 
12 )
...
-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/syncthing/5795/syncthing5795_test.go#109
```go
98 ...
99 
100 	m := newTestModel()
101 	c := NewConnection(m).(*rawConnection)
102 	m.ccFn = func() {
103 		c.Close()
104 	}
105 
106 	c.Start()
107 	c.inbox <- &ClusterConfig{}
108 
109 	<-c.dispatcherLoopStopped           // <-------
110 }
111 
```


-> /home/advocate/Advocate/Experiments/Advocate/helper/aplas/output/oocLength/9/blocking/syncthing/5795/syncthing5795_test.go#82
```go
71 ...
72 
73 		default:
...
77 }
78 
79 func (c *rawConnection) internalClose() {
80 	c.closeOnce.Do(func() {
81 		close(c.closed)
82 		<-c.dispatcherLoopStopped           // <-------
83 	})
84 }
85 
86 func (c *rawConnection) Close() {
87 	c.internalClose() // FIX: go c.internalClose()
88 }
89 
90 func NewConnection(receiver Model) Connection {
91 	return &rawConnection{
92 		dispatcherLoopStopped: make(chan struct{}),
93 
94 ...
```
